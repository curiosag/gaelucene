...
public class LuceneIndextTransfer {

	// global logger
    private static final Logger log = Logger.getLogger(LuceneIndextTransfer.class.getName());

	public static int toGoogleDataSource(File indxDir, String category) throws IOException {
