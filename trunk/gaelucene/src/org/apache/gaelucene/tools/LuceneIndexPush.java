...
public class LuceneIndexPush {
	private static final String GAE_SERVER = "http://3gmatrix-search.appspot.com/gaefile"; 
	//private static final String GAE_SERVER = "http://localhost:8080/gaefile";
	//private static final String GAE_SERVER_PROTOCOL = "http://";
	//private static final String GAE_SERVER_HOST = "localhost";
	//private static final int GAE_SERVER_PORT = 8080;
	//private static final String GAE_SERVER_APP = "/gaefile";
//	@Deprecated
//	private static boolean syncFile(File file, String category, long version, int fi) throws IOException {
...
//
//		int segmentCount = (int) (fileLength + 1) / SEGMENT_LENGTH + 1;
//		StringBuffer requestUrl = new StringBuffer(128);
//		requestUrl.append(GAE_SERVER);
//		requestUrl.append("?&do=commit");
...
//		requestUrl.append("&segments=").append(segmentCount);
//
...
//		long totalBytes = 0;
//		while(true) {
//			int bytes = fis.read(buffer, 0, 10240);
//			if (bytes < 0) {
//				if (totalBytes < fileLength) {
//					System.err.println("File was truncated? read only " + totalBytes + " bytes from is, but fileLength is " + fileLength);
//				}
//				break;
//			}
//			System.out.print(".");
...
//	}
	...
	// 用文件记录已经push成功的文件，以便处理个别需要再次上传的文件(如上次上传失败的文件)
	public static void main(String[] args) throws IOException {
		String sourceDirName = null;
		String category = null;
		String jobRecFileName = null;
		...
		if (sourceDirName == null || category == null || jobRecFileName == null) {
			System.err.println("java " + LuceneIndexPush.class.getName() + "-cat ${index-category} -src ${path-to-index-folder} -rec-file ${path-to-rec-file}");
			System.exit(-1);
		}
		...
		for (int i=0; i<files.length; i++) {
			...
			try {
				syncFile(file, category, version, i);
