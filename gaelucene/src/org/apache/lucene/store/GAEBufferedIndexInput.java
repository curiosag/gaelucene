...
public abstract class GAEBufferedIndexInput extends IndexInput {
  ...
  public GAEBufferedIndexInput() {}

  /** Inits BufferedIndexInput with a specific bufferSize */
  public GAEBufferedIndexInput(int bufferSize) {
  ...
  public long getFilePointer() { 
	  ///System.out.println("GAEBufferedIndexInput.getFilePointer - bufferStart:" + bufferStart + ", bufferPosition:" + bufferPosition);
  ...
  public Object clone() {
    GAEBufferedIndexInput clone = (GAEBufferedIndexInput)super.clone();
